...
public class ProductosController : ControllerBase
{
    ...
    private static readonly ConcurrentHashSet<string> CacheKeys = new();
    ...
    public async Task<ActionResult<ApiResponse<Producto>>> CreateProduct(CreateProductRequest request)
    {
        try
        {
            ...
            _logger.LogInformation("Product created with ID: {ProductId} - Cache invalidated", product.Id);
    ...
    public async Task<ActionResult<ApiResponse<Producto>>> UpdateProduct(int id, CreateProductRequest request)
    {
        try
        {
            ...
            _logger.LogInformation("Product updated with ID: {ProductId} - Cache invalidated", id);
    ...
    public async Task<ActionResult<ApiResponse<bool>>> DeleteProduct(int id)
    {
        try
        {
            ...
            _logger.LogInformation("Product deleted with ID: {ProductId} - Cache invalidated", id);
    ...
    public async Task<ActionResult<ApiResponse<bool>>> UpdateStock(int id, [FromBody] int newStock)
    {
        try
        {
            ...
            _logger.LogInformation("Stock updated for product {ProductId} to {NewStock} - Cache invalidated", id, newStock);
    ...
    private void InvalidateAllProductCache()
    {
        ...
        _logger.LogInformation("ALL product cache invalidated - Removed {Count} keys", keysToRemove.Count);
    }
}
